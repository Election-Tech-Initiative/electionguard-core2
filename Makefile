...
test-netstandard: build-netstandard
	...
	dotnet test -a $(PROCESSOR) -c $(TARGET) --filter TestCategory=OneShot ./bindings/netstandard/ElectionGuard/ElectionGuard.Decryption.Tests/ElectionGuard.Decryption.Tests.csproj
